...
def show_image(file, rotation_angle = 0, colormap = 'binary', num_edge_l=-13, num_edge_r=-7, scaling = 'linear'):
...
def show_ntd_image(file, colormap = 'binary', scaling = 'linear'):
    filtered_image, shot_num = show_image(file, colormap = 'binary', num_edge_l=-16, num_edge_r = -10, scaling = scaling)
    return filtered_image, shot_num
...
def show_pxtd_image(file,rotation_angle = float(.0297*180/3.1415), colormap = 'binary', scaling = 'linear'):
    filtered_image, shot_num = show_image(file, rotation_angle = rotation_angle, colormap = 'binary', scaling = scaling)
    return filtered_image, shot_num
...
def wiener_decon_lineout(time_axis, lineout, shotnum = 0, noise_left = 0, noise_right = 0, signal_left = 0, signal_right = 0, padding_length = 500, manual = True):
    ...
    signal_padding_left= np.zeros(padding_length)
